...
--
-- Хост: localhost
-- Время создания: Июн 19 2014 г., 00:15
...
INSERT INTO `admins` (`id`, `username`, `password`, `created_at`, `active`) VALUES
  (1, 'admin', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 0, 1);
...
CREATE TABLE IF NOT EXISTS `groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `curator` int(10) unsigned NOT NULL DEFAULT '0',
  `info` text NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ixCurator` (`curator`)
...
INSERT INTO `groups` (`id`, `name`, `curator`, `info`) VALUES
  (1, 'СІ-10-01', 2, '<p>Інформація</p>\r\n'),
  (4, 'СІ-10-02', 1, '<p>Інформація</p>\r\n'),
  (5, 'СІ-11-01', 1, '<p>Інформація</p>\r\n'),
  (6, 'СІ-12-01', 1, '<p>Інформація</p>\r\n');
...
INSERT INTO `lessons` (`id`, `name`, `info`) VALUES
  (2, 'Вища математика', '<p>Інформація</p>\r\n'),
  (3, 'Джава девелоперс', '<p>Інформація</p>\r\n'),
  (9, 'Test', '<p>Інформація</p>\r\n');

-- --------------------------------------------------------

--
-- Структура таблицы `lessons_files`
--
...
CREATE TABLE IF NOT EXISTS `lessons_files` (
  ...
  PRIMARY KEY (`id`),
  KEY `ixFileId` (`file_id`),
  KEY `ixLessonId` (`lesson_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=16 ;

--
-- Дамп данных таблицы `lessons_files`
--

INSERT INTO `lessons_files` (`id`, `file_id`, `lesson_id`) VALUES
  (15, 3, 9);

-- --------------------------------------------------------

--
-- Структура таблицы `lesson_numbers`
--
...
--
-- Дамп данных таблицы `lesson_numbers`
--

INSERT INTO `lesson_numbers` (`id`, `name`, `start_time`, `end_time`) VALUES
  (1, '1', '08:00:00', '09:20:00'),
  (2, '2', '09:20:00', '09:20:00'),
  (3, '3', '09:20:00', '09:20:00'),
  (4, '4', '09:20:00', '09:20:00'),
  (5, '5', '09:20:00', '09:20:00'),
  (6, '6', '09:20:00', '09:20:00'),
  (7, '7', '09:20:00', '09:20:00');
...
INSERT INTO `pages` (`id`, `name`, `link`, `data`) VALUES
  (2, 'Testing', 'test', '<p>Вміст сторінки...</p>\r\n');
...
INSERT INTO `settings` (`id`, `week_mark`) VALUES
  (1, '2014-03-24');
...
INSERT INTO `teachers` (`id`, `firstname`, `middlename`, `lastname`, `info`) VALUES
  (1, 'Василь', 'Петрович', 'Іванов', '<p>Інформація</p>\r\n'),
  (2, 'Михайло', 'Адольфович', 'Бідасюк', '<p>Інформація</p>\r\n'),
  (3, 'Роксана', 'Романівна', 'Скочинська', '<p>Інформація</p>\r\n'),
  (4, 'АА', 'аа', 'Ааа', '<p>Інформація</p>\r\n'),
  (5, 'Андрій', 'ФІайцйайц', 'Бідасюк', '<p>Інформація</p>\r\n'),
  (6, 'Васьок', 'Іва', 'Іванюк', '<p>Інформація</p>\r\n'),
  (7, 'Лол', 'ФФф', 'Тест', '<p>Інформація</p>\r\n');
...
CREATE TABLE IF NOT EXISTS `timetables` (
  ...
  `lesson_number_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lesson_id` int(10) unsigned NOT NULL DEFAULT '0',
  `classroom_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ixGroupId` (`group_id`),
  KEY `ixDayId` (`day_id`),
  KEY `ixLessonNumberId` (`lesson_number_id`),
  KEY `ixLessonId` (`lesson_id`),
  KEY `ixClassroomId` (`classroom_id`)
...
INSERT INTO `timetables` (`id`, `group_id`, `day_id`, `lesson_number_id`, `lesson_id`, `classroom_id`) VALUES
  (34, 1, 1, 1, 3, 1),
  (35, 1, 2, 1, 3, 1),
  (38, 1, 3, 2, 2, 1),
  (39, 1, 4, 7, 2, 1);
...
--
-- Структура таблицы `timetable_teachers`
--

CREATE TABLE IF NOT EXISTS `timetable_teachers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `timetable_id` int(10) unsigned NOT NULL DEFAULT '0',
  `teacher_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ixTimetableId` (`timetable_id`),
  KEY `ixTeacherId` (`teacher_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=91 ;

--
-- Дамп данных таблицы `timetable_teachers`
--

INSERT INTO `timetable_teachers` (`id`, `timetable_id`, `teacher_id`) VALUES
  (69, 35, 1),
  (70, 35, 2),
  (75, 38, 2),
  (76, 39, 2),
...
--
-- Структура таблицы `timetable_week_types`
--

CREATE TABLE IF NOT EXISTS `timetable_week_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `timetable_id` int(10) unsigned NOT NULL DEFAULT '0',
  `week_type_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ixTimetableId` (`timetable_id`),
  KEY `ixWeekTypeId` (`week_type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=38 ;

--
-- Дамп данных таблицы `timetable_week_types`
--

INSERT INTO `timetable_week_types` (`id`, `timetable_id`, `week_type_id`) VALUES
  (12, 35, 1),
  (19, 38, 1),
  (20, 39, 1),
  (21, 39, 2),
...
--
-- Дамп данных таблицы `week_types`
--

INSERT INTO `week_types` (`id`, `name`) VALUES
  (1, '1'),
  (2, '2'),
  (3, '3'),
  (4, '4');
...
--
ALTER TABLE `groups`
ADD CONSTRAINT `fkGroupsCuratorId` FOREIGN KEY (`curator`) REFERENCES `teachers` (`id`);

--
-- Ограничения внешнего ключа таблицы `lessons_files`
--
ALTER TABLE `lessons_files`
ADD CONSTRAINT `fkLessonsFilesFileId` FOREIGN KEY (`file_id`) REFERENCES `files` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkLessonsFilesLessonId` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `timetables`
--
ALTER TABLE `timetables`
ADD CONSTRAINT `fkGroupsClassroomId` FOREIGN KEY (`classroom_id`) REFERENCES `classrooms` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkGroupsDayId` FOREIGN KEY (`day_id`) REFERENCES `days` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkGroupsGrouId` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkGroupsLessonId` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkGroupsLessonNumberId` FOREIGN KEY (`lesson_number_id`) REFERENCES `lesson_numbers` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `timetable_teachers`
--
ALTER TABLE `timetable_teachers`
ADD CONSTRAINT `fkGroupsTeacherId` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkGroupsTimetableId` FOREIGN KEY (`timetable_id`) REFERENCES `timetables` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `timetable_week_types`
--
ALTER TABLE `timetable_week_types`
ADD CONSTRAINT `fkTimetablesWeekTypesTimetableId` FOREIGN KEY (`timetable_id`) REFERENCES `timetables` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fkTimetablesWeekTypesWeekTypeId` FOREIGN KEY (`week_type_id`) REFERENCES `week_types` (`id`) ON DELETE CASCADE;
